...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ?>
                            ...
                            <label class="fs-5 fw-bold"><?php  echo '&nbsp'; echo $row['course']; echo '&nbsp - &nbsp'; echo $row['year_section']; echo '&nbsp'; echo $row['firstname']; echo '&nbsp'; echo $row['lastname']; ?></label><br>
